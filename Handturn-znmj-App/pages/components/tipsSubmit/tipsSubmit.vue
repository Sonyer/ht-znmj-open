			...
			<view class="link-address-wrap">
				<view class="link-adress-content">
					...
					<view class="head-selected">
						<text class="selected-txt">我要举报</text>
					</view>
									...
									<view class='operation-info-txt'>
										<view class="operation-info-box">								
											 <view class="operation-info-box-text">
												 <input class="uni-input" cursor-spacing="20" v-model="inputInfo.tipsContent" placeholder-style="color:#c0c0c0" placeholder="写下你的举报内容...">
												<!-- <textarea class="uni-input" cursor-spacing="20" v-model="inputInfo.tipsContent" placeholder-style="color:#c0c0c0" placeholder="写下你的举报内容...">
												</textarea> -->
											 </view>
										</view>
									</view>
