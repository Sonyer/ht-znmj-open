...
public class DateUtil {
    ...
    //日期验证正则表达式
    public static final String yearPattern = "^[12][0-9]{3}$";
    public static final String monthPattern = "^[12][0-9]{3}-(0?[1-9]|1[0-2])$";
    ...
    public static final String dayPattern = String.format("^[12][0-9]{3}-(%s|%s|%s)$", janPattern, febPattern, aprPattern);
    public static final String hourFormat = String.format("^[12][0-9]{3}-(%s|%s|%s) ([01][0-9]|2[0-3]):00:00$", febPattern, janPattern, aprPattern);
    public static final String timeFormat = String.format("^[12][0-9]{3}-(%s|%s|%s) ([01][0-9]|2[0-3])(:[0-5][0-9]){2}$", febPattern, janPattern, aprPattern);
  ...
  /*  public static boolean isDate(String str,String formatStr) {
    ...
    public  static void main(String[] args) throws ParseException {
        /*System.out.println(isDate("1900-01-01",dayPattern));
        Date mfgDate = formatStr2Date("1900-01-01",DATA_PATTERN);
        Date expDate = com.handturn.bole.common.utils.DateUtil.days(mfgDate,-365);
