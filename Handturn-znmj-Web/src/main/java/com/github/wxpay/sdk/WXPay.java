...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.keySet().forEach(datakey ->{
            System.out.println(datakey+":" + reqData.get(datakey));
        });
        System.out.println("签名sign:" + WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
     ...
     * @throws Exception
     */
    public Map<String, String> fillTransfersRequestData(Map<String, String> reqData) throws Exception {
    ...
    */
    ...
    public Map<String, String> transfer(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = "/sandboxnew/mmpaymkttransfers/promotion/transfers";
        }
        else {
            url = "/mmpaymkttransfers/promotion/transfers";
        }
        String respXml = this.requestWithCert(url, this.fillTransfersRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
    /*------------------------------------------添加提现----------------------------------------------end
