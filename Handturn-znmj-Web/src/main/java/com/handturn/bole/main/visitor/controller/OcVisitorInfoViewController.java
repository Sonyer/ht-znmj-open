...
@Validated
@Controller
public class OcVisitorInfoViewController extends BaseController {
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "main/visitor/ocVisitorInfo")
    ...
    public String view(Model model) {
        ...
        return FebsUtil.view("main/visitor/ocVisitorInfo/ocVisitorInfoList");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "main/visitor/ocVisitorInfo/add")
    @RequiresPermissions("main:visitor:ocVisitorInfo:add")
    public String add(Model model) {
        //组装新增对象
        OcVisitorInfo ocVisitorInfo = new OcVisitorInfo();
        ...
        model.addAttribute("ocVisitorTypeOption",ocVisitorTypeOption);
        return FebsUtil.view("main/visitor/ocVisitorInfo/ocVisitorInfoEdit");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "main/visitor/ocVisitorInfo/update/{ocVisitorInfoId}")
    @RequiresPermissions("main:visitor:ocVisitorInfo:view")
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "main/visitor/ocVisitorInfo/authShow/{ocVisitorInfoId}")
    ...
    public String authShow(@PathVariable Long ocVisitorInfoId, Model model) {
        ...
        return FebsUtil.view("main/visitor/ocVisitorInfo/ocVisitorInfoAuth");
    }
