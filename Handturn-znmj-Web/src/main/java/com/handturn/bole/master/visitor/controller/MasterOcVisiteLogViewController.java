...
@Validated
@Controller
public class MasterOcVisiteLogViewController extends BaseController {
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "master/visitor/ocVisiteLog")
    ...
    public String view(Model model) {
        ...
        return FebsUtil.view("master/visitor/ocVisiteLog/ocVisiteLogList");
    }
}
