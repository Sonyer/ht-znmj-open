...
@Validated
@RestController
@RequestMapping("sitapi/imgShow")
public class CommonImgShowController extends BaseController {
    ...
    public void logoImgShow(@NotBlank(message = "{required}") @PathVariable String typeName,
        ...
        try {
            commonImgShowService.imgShow(typeName,dateStr,fileName,request, response);
        }catch (Exception e){
