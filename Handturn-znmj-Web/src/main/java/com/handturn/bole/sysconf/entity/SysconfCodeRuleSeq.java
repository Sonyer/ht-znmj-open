 ...
 */
@Data
@TableName("sysconf_code_rule_seq")
@Excel("系统配置-编码流水")
public class SysconfCodeRuleSeq extends BasicEntity{
     ...
     * 规则键
     */
    @TableField("rule_code_key")
    @ExcelField(value = "规则键")
    private String ruleCodeKey;

    /**
     * 初始值
     */
    @TableField("rule_code_init")
    @ExcelField(value = "初始值")
    private Long ruleCodeInit;

    /**
     * 流水号
     */
    @TableField("seq_num")
    @ExcelField(value = "流水号")
    private Long seqNum;
